 ...
 * Orchestrates status checks and allergy/interaction analysis, applying OpenO-specific
...
public interface VigilanceManager {
     ...
     * Returns null if allergy warnings are disabled via {@code rx3.disable_allergy_warnings}.
     *
    ...
    /**
     * Performs allergy/interaction analysis for a patient's prescription stash.
     ...
     */
    VigilanceAnalysisResult analyzeAllergy(LoggedInInfo loggedInInfo, int demographicNo, List<RxPrescriptionData.Prescription> stash);
}
