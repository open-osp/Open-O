...
%>
	...
	<tr>
    	<td align="center"><a href=# onClick ="popupPage(350,860,'../setProviderStaleDate.do?method=viewHl7LabResultPrefs');return false;"><bean:message key="provider.btnViewHl7LabPrefs"/></a></td>
    </tr>
   <tr>
