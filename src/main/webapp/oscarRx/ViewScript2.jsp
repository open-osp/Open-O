...
if(bMultisites) {
    ...
    oscar.oscarRx.data.model.Provider rxprovider = new oscar.oscarRx.data.RxProviderData().getProvider(bean.getProviderNo());
...
<%--                                        </tr>--%>
					...
					<%
                        for(int i=0; i<bean.getStashSize(); i++){
                            oscar.oscarRx.data.model.Prescription rx
                                = bean.getStashItem(i);
