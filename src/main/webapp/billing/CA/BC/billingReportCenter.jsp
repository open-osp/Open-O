...
<%--											 face="Verdana, Arial, Helvetica, sans-serif">--%>
	...
	<tr>
		...
		<td width="25%">
			...
			<font size="1" face="Arial, Helvetica, sans-serif">
				<a href="#" onClick="openBrWindow('billingCalendarPopup.jsp?type=&returnItem=xml_appointment_date&returnForm=serviceform&year=<%=curYear%>&month=<%=curMonth%>','','width=300,height=300')">End:</a>
			</font>
