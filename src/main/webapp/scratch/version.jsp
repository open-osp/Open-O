...
<head>
    <title><bean:message key="ScratchPad.title"/> <%=Encode.forHtmlContent(title)%>
    </title>
...
<div class="container">
    ...
    <div class="heading">
        <div class="page-title">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-list"
                ...
                <bean:message key="ScratchPad.title"/>
            </h2>
        </div>
        <div class="user-name">
    ...
    <table class="MainTable table-condensed table-borderless" id="scrollNumber1">
        <tr>
            <td>&nbsp;</td>
            <td>
                <div class="pad-version"><bean:message key="ScratchPad.title"/> <%=Encode.forHtmlContent(title)%>
                </div>
            </td>
        </tr>
        <tr>
